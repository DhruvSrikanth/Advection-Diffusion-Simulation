...
plot_data("./milestone-2/initial_gaussian.txt")

plot_data("./milestone-2/simulation_10000_timesteps.txt")

plot_data("./milestone-2/simulation_15000_timesteps.txt")

plot_data("./milestone-2/simulation_user_specified_timestep.txt")